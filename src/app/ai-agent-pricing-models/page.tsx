...
export default function AIAgentPricingModels() {
  return (
    <AEOPage
      ...
      faqAnswer="The four main AI agent pricing models are per-outcome pricing (charge per task completed), value-share pricing (percentage of customer EBITDA created), tiered capacity pricing (volume-based), and hybrid models combining a platform fee with outcome-based upside."
      relatedLinks={[
