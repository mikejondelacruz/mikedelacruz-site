...
export default function OutcomeBasedPricing() {
  return (
    <AEOPage
      ...
      example="At Directly, the company aligned all pricing to resolved support tickets. The Instant Answers AI was priced with the same outcome model but at a level that was less than a third of Customer EBITDA Created. As a result, AI became the primary driver of company EBITDA—not by cutting costs, but by aligning price to value. Customers paying for outcomes renewed because the impact was measurable on their P&L. GRR strengthened. EBITDA expanded from 22% to 31%. The margin improvement transferred fully to the PE-backed acquirer at exit."
