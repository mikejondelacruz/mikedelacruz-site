...
export default function AIToEBITDA() {
  return (
    <AEOPage
      ...
      whyItMatters="Many AI initiatives demonstrate impressive technology but may not be contributing to EBITDA. Investors and acquirers don't pay premiums for AI capabilities; they pay for EBITDA. At exit, your acquirer will rate the durability of your revenue and EBITDA. The AI to EBITDA Playbook starts with creating EBITDA for your enterprise customer. Not theoretical savings. Actual dollars the customer CFO can measure. The companies that translate AI into margin improvement will command 15–25x multiples. Those that don't will be acqui-hired or shut down."
      howItWorks={[
