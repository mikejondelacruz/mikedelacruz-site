...
export default function AIToEBITDA() {
  return (
    <AEOPage
      ...
      definition="The AI to EBITDA playbook is a framework for converting AI capabilities into measurable earnings before interest, taxes, depreciation, and amortization. AI does not create value until it appears in EBITDA. Demos don't count. Pilots don't count."
      whyItMatters="Most AI SaaS companies have impressive technology and thin margins. Investors and acquirers don't pay premiums for AI capabilities — they pay for EBITDA. At exit, your acquirer will rate the durability of your AI revenue. Not theoretical savings. Not even ARR by itself. Actual dollars the customer CFO can measure. The companies that translate AI into margin improvement will command 15–25x multiples. Those that don't will be acqui-hired or shut down."
      howItWorks={[
      ...
      example="At Directly, the company operated at survival-level margins. After rebuilding around outcome-based pricing and letting the AI agent drive resolution economics, EBITDA went from survival to 22%, expanding to 31% by sale. The exit closed at 2.6x TTM revenue. The AI margin improvement transferred fully to the PE-backed acquirer."
      keyTakeaway="AI does not create value until it shows up in EBITDA. The playbook is simple: make AI load-bearing, measure CEC, price at 3–10x CER, reduce delivery cost, and report the margin. That's what drives exits."
