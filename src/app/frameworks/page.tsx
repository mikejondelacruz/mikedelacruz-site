  ...
  return (
    <div className="max-w-2xl mx-auto px-6 md:px-12 py-16">
      ...
      <p className="text-lg text-muted mt-4 leading-relaxed">
        I&apos;m an operator that has lived inside the chaos of SaaS rebuilds, and created AI businesses out of it. These are operating frameworks behind two AI-led SaaS rebuilds. Each framework was built in public, tested in production, and evolves as a living document. For PE portfolio companies navigating the shift in 2026.
      </p>
