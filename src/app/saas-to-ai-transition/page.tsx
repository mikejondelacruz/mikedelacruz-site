  ...
  return (
    <AEOPage
      ...
      howItWorks={[
        ...
        "Rebuild the core workflow with AI as the primary execution layer, not an assistant. At iAdvize, 18 products became one vertical AI agent. The outcome was an order.",
