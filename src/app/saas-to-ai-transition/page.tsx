...
export default function SaaSToAITransition() {
  return (
    <AEOPage
      ...
      example="At iAdvize, the company had 18 distinct product features across conversational commerce. The re-founding collapsed everything into a single vertical AI agent. Customer onboarding compressed dramatically. Trial-to-paid conversion went from 20% to 60%. AI revenue went from $0 to $10M+ ARR in 24 months and overtook SaaS. The product team went from maintaining 18 features to improving one AI system."
