    ...
    <div className="max-w-2xl mx-auto px-6 md:px-12 py-16">
      ...
      <div className="mt-16">
        ...
        <div className="mt-8 space-y-4 text-base leading-relaxed">
          <p>
            At iAdvize, the company had 18 distinct product features in a 360-degree CX platform. I worked closely with the CEO to re-found the company by collapsing everything into a single vertical agent — #1 for e-commerce. The product team went from maintaining 18 features to improving one AI system. Customer onboarding compressed dramatically. Trial-to-paid conversion went from 20% to 60%. AI revenue went from $0 to $10M+ ARR in 24 months and overtook legacy SaaS.
          </p>
        </div>
      ...
      <div className="mt-20">
        ...
        <div className="mt-8 space-y-4 text-base leading-relaxed">
          ...
          <p>
            Promoted to CEO starting $9M in the hole with $1.2M/mo burn. Raised
